...
async function getForecast(long, lat, units) {
    const forecast = await fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${long}&lon=${lat}&exclude=minutely,alerts&units=${units}&appid=07d6d743abf155d07011e87ead210d57`);
